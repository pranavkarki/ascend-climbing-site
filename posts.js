...
const POSTS = [
  ...
  // ── EVENTS ─────────────────────────────────────────────────────────────────
  {
    id: 1,
    cat: "event",
    date: "28.06.26",          // UPDATE when event is confirmed
    title: "Boulder Brawl Vol. 04 — Open Comp",
    excerpt: "Doors 10:00, first call 11:00. Forty boulders, three rounds, no qualifiers — just send. Cash prizes and chai until the cups run out.",
    read: "3 min",
  ...
  // ── ROCK DAY ───────────────────────────────────────────────────────────────
  {
    id: 3,
    cat: "rock",
    date: "24.05.26",          // UPDATE to actual trip date
    ...
    read: "6 min",
    img: "img/stories/nagarjun.jpg",        // replace with real photo
